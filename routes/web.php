...
Route::middleware('auth')->group(function (): void {
    ...
    // Inspection Records (admin only)
    Route::middleware('permission:view-records')->group(function (): void {
    ...
    Route::middleware('permission:manage-templates')->group(function (): void {
